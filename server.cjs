...
var mockPatients = [
  {
    ...
    bmi: 28.3,
    labHistory: [
      { date: "2025-09", fastingGlucose: 165, hba1c: 8.2, creatinine: 0.95, egfr: 65, uacr: 45 },
      { date: "2025-12", fastingGlucose: 158, hba1c: 7.9, creatinine: 0.98, egfr: 61, uacr: 52 },
      { date: "2026-03", fastingGlucose: 145, hba1c: 7.6, creatinine: 1.05, egfr: 58, uacr: 68 },
      { date: "2026-06", fastingGlucose: 172, hba1c: 8.3, creatinine: 1.15, egfr: 52, uacr: 110 }
    ],
    nutritionHistory: [
      {
        id: "N-881-01",
  ...
  },
  {
    ...
    bmi: 30,
    labHistory: [
      { date: "2025-09", fastingGlucose: 110, hba1c: 6.2, creatinine: 0.85, egfr: 92, uacr: 12 },
      { date: "2025-12", fastingGlucose: 126, hba1c: 6.5, creatinine: 0.88, egfr: 90, uacr: 15 },
      { date: "2026-03", fastingGlucose: 142, hba1c: 7.2, creatinine: 0.9, egfr: 88, uacr: 22 },
      { date: "2026-06", fastingGlucose: 198, hba1c: 8.8, creatinine: 0.94, egfr: 85, uacr: 28 }
    ],
    nutritionHistory: [
      {
        id: "N-882-01",
  ...
  },
  {
    ...
    bmi: 21,
    labHistory: [
      { date: "2025-09", fastingGlucose: 132, hba1c: 7.1, creatinine: 1.45, egfr: 42, uacr: 240 },
      { date: "2025-12", fastingGlucose: 135, hba1c: 7.2, creatinine: 1.58, egfr: 38, uacr: 290 },
      { date: "2026-03", fastingGlucose: 125, hba1c: 6.9, creatinine: 1.68, egfr: 35, uacr: 320 },
      { date: "2026-06", fastingGlucose: 138, hba1c: 7.3, creatinine: 1.85, egfr: 31, uacr: 410 }
    ],
    nutritionHistory: [
      {
        id: "N-883-01",
...
function getLocalPatientAnalyze(patient) {
  ...
  const a1cTrendStr = parseFloat(a1cDiff) > 0 ? `\u7CD6\u5316\u8840\u8272\u7D20\u81EA\u5148\u524D\u4E4B ${firstLab.hba1c}% \u6500\u5347\u81F3\u6700\u65B0\u4E4B ${currentLab.hba1c}%\uFF08\u7D2F\u7A4D\u5F48\u5347 ${a1cDiff}%\uFF09\uFF0C\u53CD\u6620\u8FD1\u671F\u5728\u4E3B\u98DF\u78B3\u6C34\u3001\u9EDE\u5FC3\u6C34\u679C\u7CD6\u5206\u7BA1\u7406\u4E0A\u5B58\u5728\u660E\u986F\u7684\u4EE3\u8B1D\u5931\u511F\uFF0C\u80F0\u5CF6\u4EE3\u511F\u6A5F\u5236\u8DA8\u5411\u904E\u8377\u904B\u4F5C\u3002` : `\u7CD6\u5316\u8840\u8272\u7D20\u81EA\u5148\u524D\u4E4B ${firstLab.hba1c}% \u5FAE\u5E45\u8ABF\u964D\u81F3\u6700\u65B0\u4E4B ${currentLab.hba1c}%\uFF0C\u986F\u793A\u524D\u671F\u53E3\u670D\u8ABF\u6574\u6216\u751F\u6D3B\u9650\u7CD6\u53D6\u5F97\u5C40\u90E8\u6B63\u5411\u9032\u5EA6\uFF0C\u4E0B\u968E\u6BB5\u4ECD\u9700\u8457\u91CD\u65BC\u6E1B\u5C11\u7A7A\u8179\u8840\u7CD6\u9707\u5E45\u3002`;
  const egfrDiff = (firstLab.egfr - currentLab.egfr).toFixed(0);
  const egfrTrendStr = parseFloat(egfrDiff) > 0 ? `\u814E\u7D72\u7403\u904E\u6FFE\u7387 eGFR \u6301\u7E8C\u4E0B\u6ED1\uFF08\u5F9E\u5148\u524D ${firstLab.egfr} \u964D\u81F3\u6700\u65B0 ${currentLab.egfr} mL/min/1.73m\xB2\uFF0C\u5171\u8870\u9000 ${egfrDiff} \u55AE\u4F4D\uFF09\uFF0C\u4EE3\u8868\u6162\u6027\u814E\u75C5\u7A0B\u6B63\u671D CKD \u6162\u6027\u814E\u5C0F\u7403\u904E\u6FFE\u7B2C ${currentLab.egfr < 30 ? "4" : "3"} \u671F\u4E2D\u671F\u6DF1\u5EA6\u63A2\u5E95\u3002\u9700\u63D0\u65E9\u85C9\u7531\u4F4E\u6C2E\u81B3\u98DF\u4ECB\u5165\uFF0C\u6E1B\u5C11\u542B\u6C2E\u5EE2\u7269\u5C0D\u5269\u9918\u814E\u5143\u7684\u8D85\u6FFE\u904E\u7834\u58DE\u3002` : `eGFR \u6307\u6A19\u4F9D\u7136\u7DAD\u63A7\u65BC ${currentLab.egfr} mL/min \u5E73\u53F0\uFF0C\u96D6\u63A7\u5236\u4E86\u8870\u9000\u659C\u7387\uFF0C\u4F46\u7531\u65BC\u8D77\u9EDE\u5FAE\u86CB\u767D\u6392\u6CC4\u672A\u6E1B\uFF0C\u4ECD\u7136\u8981\u52A0\u7DCA\u9650\u9209\u9650\u9E7D\u8ABF\u7406\u3002`;
  const kidneyTrendStr = currentLab.uacr > firstLab.uacr ? `\u5C3F\u767D\u86CB\u767D\u6BD4\u503C UACR \u81EA\u5148\u524D ${firstLab.uacr} mg/g \u5927\u5E45\u98C6\u5347\u81F3\u6700\u65B0\u4E4B ${currentLab.uacr} mg/g\uFF0C\u9AD8\u5EA6\u78BA\u8A8D\u814E\u7D72\u7403\u57FA\u5E95\u534A\u900F\u819C\u5FAE\u8840\u7BA1\u5185\u76AE\u901A\u900F\u6027\u5728\u7CD6\u6BD2\u6027\u8207\u704C\u6CE8\u58D3\u8907\u5408\u6253\u64CA\u4E0B\u6B63\u767C\u751F\u8DB3\u5C0F\u7A81\u6495\u88C2\u3002\u6B64\u6307\u6A19\u8207\u8840\u6E05\u808C\u9178\u9150\u4E0A\u63DA\u81F3 ${currentLab.creatinine} mg/dL \u7684\u8ECC\u8DE1\u5341\u5206\u543B\u5408\uFF0C\u5FC5\u9808\u7ACB\u5373\u9632\u5316\u3002` : `\u5C3F\u767D\u86CB\u767D\u7DAD\u6301\u5728 ${currentLab.uacr} mg/g \u8ECC\u8DE1\uFF0C\u53CD\u6620\u5DF2\u6709\u5FAE\u91CF\u81F3\u4E2D\u5EA6\u6EF2\u6F0F\u3002\u96D6\u7136\u6709\u5C0F\u5E45\u5EA6\u4FEE\u88DC\uFF0C\u4F46\u52D9\u5FC5\u4F34\u96A8\u8840\u58D3\u63A7\u5236\u5728 130/80 mmHg \u4EE5\u4E0B\uFF0C\u4EE5\u4FDD\u57FA\u5E95\u819C\u5B8C\u5168\u4FEE\u5FA9\u3002`;
...
function getLocalPatientAnalyzeNutrition(patient) {
  const currentLab = patient.labHistory[patient.labHistory.length - 1];
  ...
  if (currentLab.egfr >= 60) {
    ...
    proteinGrams = `${Math.round(idealWeight * 0.8)} ~ ${Math.round(idealWeight * 1)} \u514B/\u5929`;
...
2. \u751F\u5316\u6307\u6A19 (Biochemical): 
   ...
   - \u814E\u81DF\u4EE3\u8B1D\uFF1A\u8840\u6E05\u808C\u9178\u9150 ${currentLab.creatinine} mg/dL\u3001eGFR \u814E\u904E\u6FFE\u7387 ${currentLab.egfr} mL/min/1.73m\xB2 (\u9032\u5165\u6162\u6027\u814E\u81DF\u75C5\u7B2C\u4E09\u671F\u6BB5)
...
function getLocalPatientNutritionSummary(patient, selectedTopics, nutritionistNotes) {
  const currentLab = patient.labHistory[patient.labHistory.length - 1];
...
## \u4E00\u3001\u672C\u6B21\u9580\u8A3A\u7232\u60A8\u7279\u5225\u7CBE\u7DE8\u4E4B\u9910\u684C\u843D\u5BE6\u8A08\u756B
${selectedTopics.map((t, index) => `### ${index + 1}. \u3010${t.title}\u3011
*   **\u6307\u5357\u91CD\u9EDE**\uFF1A${t.description}
*   **\u71DF\u990A\u5E2B\u73FE\u5834\u6307\u5C0E\u5BE6\u8E10\u7AC5\u9580**\uFF1A
...
function getLocalPatientSummary(patient, selectedTopics, educatorNotes) {
  const currentLab = patient.labHistory[patient.labHistory.length - 1];
  const pronoun = patient.gender === "M" ? "\u5927\u54E5" : "\u963F\u59E8";
  const nameSuffix = patient.name.slice(1);
  const displayName = `${nameSuffix}${pronoun}`;
...
${selectedTopics.map((t, index) => `### \u25A0 ${t.title} (${t.category === "diet" ? "\u6B63\u9910\u98F2\u98DF\u6307\u5357" : t.category === "kidney_care" ? "\u4FDD\u814E\u8B77\u539F\u6838\u5FC3" : t.category === "medication" ? "\u5E38\u898F\u5E38\u5099\u670D\u85E5" : "\u81EA\u6211\u4F5C\u606F\u8ABF\u9069"})
...
\u8ACB\u56B4\u683C\u4F7F\u7528\u7E41\u9AD4\u4E2D\u6587(\u53F0\u7063\u7528\u8A9E)\u56DE\u8986\uFF0C\u4E26\u4F9D\u7167\u6307\u5B9A\u7684 JSON \u683C\u5F0F\u3002`;
            ...
            properties: {
              abnormalItems: {
                ...
                items: {
                  type: import_genai.Type.OBJECT,
                  properties: {
                    item: { type: import_genai.Type.STRING, description: "\u6AA2\u9A57\u9805\u76EE\u540D\u7A31\u53CA\u7576\u524D\u6578\u503C\uFF0C\u4F8B\u5982\uFF1A\u7CD6\u5316\u8840\u8272\u7D20 (8.3%)" },
                    value: { type: import_genai.Type.STRING, description: "\u6AA2\u9A57\u7279\u5B9A\u6578\u503C" },
                    reference: { type: import_genai.Type.STRING, description: "\u81E8\u5E8A\u6A19\u6E96\u53C3\u8003\u7BC4\u570D" },
                    status: { type: import_genai.Type.STRING, description: "\u72C0\u614B\u5224\u5B9A\uFF0C\u5FC5\u9808\u662F 'high' \u3001 'low' \u6216 'danger'" },
                    insight: { type: import_genai.Type.STRING, description: "\u81E8\u5E8A\u6A5F\u8F49\u89E3\u8B80\u6216\u500B\u4EBA\u5316\u4E0D\u826F\u53CD\u61C9\u9810\u8B66" }
                  },
              ...
              recommendedTopics: {
                ...
                items: {
                  type: import_genai.Type.OBJECT,
                  properties: {
                    id: { type: import_genai.Type.STRING, description: "\u82F1\u6578\u5B57\u5C0F\u5BEB\u552F\u4E00ID\uFF0C\u5982 diet_sodium \u3001 kidney_protein \u3001 lifestyle_aerobic" },
                    category: { type: import_genai.Type.STRING, description: "\u885B\u6559\u4E3B\u8EF8\uFF0C\u5FC5\u9808\u70BA 'diet', 'medication', 'lifestyle', \u6216 'kidney_care'" },
                    title: { type: import_genai.Type.STRING, description: "\u885B\u6559\u55AE\u5143\u6A19\u984C" },
                    description: { type: import_genai.Type.STRING, description: "\u8A72\u885B\u6559\u55AE\u5143\u70BA\u8A72\u75C5\u60A3\u91CF\u8EAB\u8A02\u88FD\u7684\u6559\u5B78\u5927\u7DB1\u8207\u52D5\u6A5F\u5F15\u5C0E" }
                  },
                  required: ["id", "category", "title", "description"]
                }
              },
              a1cTrendInterpretation: { type: import_genai.Type.STRING, description: "\u91DD\u5C0D HbA1c \u56DB\u671F\u6AA2\u9A57\u8DA8\u52E2\u7684\u5C08\u696D\u5224\u8B80" },
              egfrTrendInterpretation: { type: import_genai.Type.STRING, description: "\u91DD\u5C0D eGFR \u814E\u529F\u80FD\u8870\u9000\u9032\u7A0B\u8207\u6162\u6027\u814E\u75C5\u8B8A\u671F\u6578\u5206\u7D1A\u7684\u6DF1\u5C64\u8A55\u4F30" },
              kidneyInterpretation: { type: import_genai.Type.STRING, description: "\u91DD\u5C0D\u808C\u9178\u9150\u8207 UACR \u86CB\u767D\u5C3F\u6BD4\u503C\u7684\u4EA4\u4E92\u60E1\u5316\u6307\u6A19\u5224\u8B80" },
              glucoseInterpretation: { type: import_genai.Type.STRING, description: "\u7A7A\u8179\u8840\u7CD6\u6CE2\u5E45\u8207\u63A7\u5236\u72C0\u6CC1\u5256\u6790" },
              generalAssessment: { type: import_genai.Type.STRING, description: "\u5F70\u79C0\u91AB\u9662\u885B\u6559\u6307\u5C0E\u5C08\u4EFB\u7D9C\u5408AI\u8A55\u8A9E\u8207\u75C5\u60A3\u9810\u5F8C\u5F15\u5C0E" }
            },
            required: [
              "abnormalItems",
              "recommendedTopics",
  ...
  app.post("/api/patient/analyze-nutrition", async (req, res) => {
    const { patient } = req.body;
    if (!patient) {
...
\u8ACB\u56B4\u683C\u4F7F\u7528\u7E41\u9AD4\u4E2D\u6587(\u53F0\u7063\u91AB\u5B78\u71DF\u990A\u754C\u5E38\u7528\u8853\u8A9E)\u56DE\u8986\uFF0C\u4E26\u7B26\u5408\u898F\u5B9A\u7684 JSON \u683C\u5F0F\u3002`;
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            type: import_genai.Type.OBJECT,
            properties: {
              bmiEvaluation: { type: import_genai.Type.STRING, description: "\u5C0D\u75C5\u60A3\u8EAB\u9AD8\u3001\u9AD4\u91CD\u3001BMI\u53CA\u80A5\u80D6\u6216\u808C\u8089\u6D41\u5931\u98A8\u96AA\u7684\u8A55\u4F30" },
              metabolicAssessment: { type: import_genai.Type.STRING, description: "\u57FA\u65BC\u751F\u5316\u5831\u544A\u7684\u6700\u65B0\u81E8\u5E8A\u4EE3\u8B1D\u7279\u5FB5\u8207\u71DF\u990A\u4E0D\u5747\u8B66\u8A9E" },
              adimeDraft: { type: import_genai.Type.STRING, description: "\u5B8C\u6574\u7684\u3001\u6BB5\u843D\u6E05\u6670\u7684\u5C08\u696D ADIME \u71DF\u990A\u7167\u8B77\u7D00\u9304\u96FB\u5B50\u75C5\u6B77\u8349\u7A3F" },
              recommendedDietTopics: {
                type: import_genai.Type.ARRAY,
                ...
                items: {
                  type: import_genai.Type.OBJECT,
                  properties: {
                    id: { type: import_genai.Type.STRING, description: "\u4E3B\u984C\u4EE3\u78BC\u5982 diet_na, diet_prot, diet_p, diet_carb" },
                    category: { type: import_genai.Type.STRING, description: "\u71DF\u990A\u885B\u6559\u985E\u5225\uFF0C\u56FA\u5B9A\u70BA diet" },
                    title: { type: import_genai.Type.STRING, description: "\u98F2\u98DF\u885B\u6559\u9805\u76EE\u6A19\u984C" },
                    description: { type: import_genai.Type.STRING, description: "\u6B64\u9805\u751F\u6D3B\u53EE\u5680\u8207\u5F70\u79C0\u65E5\u5E38\u914D\u81B3\u5EFA\u8B70" }
                  },
                  required: ["id", "category", "title", "description"]
                }
              }
  ...
  app.post("/api/patient/generate-nutrition-summary", async (req, res) => {
...
\u71DF\u990A\u5E2B\u73FE\u5834\u70BA\u5176\u6311\u9078\u7DE8\u6392\u7684\u95DC\u9375\u885B\u6559\u55AE\u5143\uFF1A
${selectedTopics.map((t) => `- \u3010${t.title}\u3011 : ${t.description}`).join("\n")}
...
\u8ACB\u8F38\u51FA\u7CBE\u7F8E\u6392\u7248\u3001\u4FBF\u65BC\u95B1\u8B80\u7684\u7D14 Markdown \u683C\u5F0F\u3002`;
  ...
  app.post("/api/patient/generate-summary", async (req, res) => {
...
\u885B\u6559\u5E2B\u5728\u9580\u8A3A\u70BA\u4ED6\u6311\u9078\u4E26\u5B8C\u6210\u7684\u4E3B\u984C\uFF1A
${selectedTopics.map((t) => `- \u3010${t.title}\u3011 (${t.category}) : ${t.description}`).join("\n")}
...
\u8ACB\u8F38\u51FA\u7D14 Markdown \u683C\u5F0F\uFF0C\u4E0D\u8981\u5305\u542B wrapping JSON\uFF0C\u4EE5\u4F9B\u524D\u7AEF\u76F4\u63A5\u6E32\u67D3\u6E32\u67D3\u3002`;
  ...
  app.post("/api/session/save", (req, res) => {
    ...
    const sessionId = `sess_${Date.now()}_${Math.floor(Math.random() * 1e3)}`;
